...
while a: # a=1 olduğu sürece kod çalışcaktır.
    ...
    if girdi == "Google":
        ...
        os.startfile("C:/Program Files/BraveSoftware/Brave-Browser/Application/brave.exe") # Brave uygulamasını çalışıtırır.

        c = webbrowser.get() # Varsayılan tarayıcı olan chorme uygulaması nı çalışıtıryor ardından facebook sitesini bu tarayıcı ile açıyor.
        c.open("http://www.facebook.com")

        webbrowser.open("http://www.instagram.com") #Chorme uygulaması ile açıyor.
