...
while a: # a=1 olduğu sürece kod çalışcaktır.
    ...
    elif girdi == "Facebook": # Çözümü: https://www.geeksforgeeks.org/python-script-to-open-a-web-browser/?ref=rp
    ...
    elif "orada mısın" in girdi: # Komutun içinde belirtilen kelime(ler) geçerse çalışacak bir komut.
